...
static const char *const TAG = "yadsmr";
...
bool YaDsmr::ready_to_request_data_() {
...
bool YaDsmr::request_interval_reached_() {
...
bool YaDsmr::receive_timeout_reached_() { return millis() - this->last_read_time_ > this->receive_timeout_; }

bool YaDsmr::available_within_timeout_() {
...
void YaDsmr::start_requesting_data_() {
  if (!this->requesting_data_) {
    if (this->request_pin_ != nullptr) {
...
void YaDsmr::stop_requesting_data_() {
  if (this->requesting_data_) {
    if (this->request_pin_ != nullptr) {
...
void YaDsmr::receive_encrypted_telegram_() {
  while (this->available_within_timeout_()) {
    const char c = this->read();
...
void YaDsmr::set_decryption_key(const std::string &decryption_key) {
